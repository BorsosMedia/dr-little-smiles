...
const Cavities = () => {
  return(
    <article>
      ...
      <p><span>Tooth decay</span>, commonly referred to as cavities, is a chronic disease initiated by acid-producing bacteria, primarily Streptococcus mutans. </p>
      <p>These bacteria thrive on food particles, particularly those high in sugars and starches, and in turn, they generate acid that erodes tooth enamel. This ongoing acid exposure results in the development of small holes and enamel damage, ultimately leading to the formation of cavities.</p>
